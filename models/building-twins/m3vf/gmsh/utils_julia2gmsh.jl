...
"""
Converts a Julia geometry file 'input' (.jl) in the current directory to a Gmsh .geo file with name 'output' (.geo). 
...
"""
function julia2gmsh(input::String, output::String)
